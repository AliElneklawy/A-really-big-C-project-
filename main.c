...
int menu()
{
    ...
    do
    {
        ...
        printf(" Add a book.                        ");
        gotoxy(21, 6);
        printf(" Display books available.           ");
        gotoxy(21, 7);
        printf(" Search by author.                  ");
        gotoxy(21, 8);
        printf(" Search by book title.              ");
        gotoxy(21, 9);
        printf(" Show number of books we have.      ");
        gotoxy(21, 10);
        printf(" Set password                       ");
        gotoxy(21, 11);
        printf(" Edit the library.                  ");
        gotoxy(21, 12);
        printf(" Delete a book                      ");
        gotoxy(21, 13);
        printf(" Theme mode.                        ");
        gotoxy(21, 14);
        printf(" Golden millionaire game.           ");
        gotoxy(21, 15);
        printf(" MP3 QURA'AN                        ");
        gotoxy(21, 16);
        printf(" Exit.                              ");
...
int main()
{
   ...
   // load and play mp3
   handle=FSOUND_Sample_Load (0,"Saad Lamjarred & Zouhair Bahaoui - Lewjah Tani   2021   ��� ����� � ���� ����� -  ���� ������.mp3",0, 0, 0);
...
int quraan_main_menu()
{
    ...
    do
    {
        ...
        gotoxy(21, 5);
        printf(" Khalid Al-Jalil                     ");
        gotoxy(21, 6);
        printf(" Yasser Al-Dossary                   ");
        gotoxy(21, 7);
        printf(" Turn off the sound in the background");
...
draw_edit_menu()
{
    ...
    do
    {
        ...
        gotoxy(56, 5);
        printf(" Edit the name of the book ");
        gotoxy(56, 6);
        printf(" Edit the name of the author ");
        gotoxy(56, 7);
        printf(" Edit price ");
        gotoxy(56, 8);
        printf(" Edit the number of pages ");
        gotoxy(56, 9);
        printf(" Edit the number of avialable books ");
        gotoxy(56, 10);
        printf(" Edit all ");
